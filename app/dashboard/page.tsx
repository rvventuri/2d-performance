    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8">
        {[
          ...
          <div key={i} className={`bg-card border border-border rounded-xl p-4 ${i === 2 ? "col-span-2 sm:col-span-1" : ""}`}>
        ...
        <div className="text-center py-20 bg-card border border-border rounded-xl">
          {students.length === 0 ? (
            <>
              ...
              <p className="text-muted-foreground text-sm mb-6">Comece cadastrando seu primeiro aluno para iniciar as avaliações.</p>
              <Link href="/students/new">
